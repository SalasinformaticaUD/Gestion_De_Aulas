...
export class EstudiantesService {
  ...
  findAll(query?: string) { return this.prisma.estudiante.findMany({ where: query ? { OR: [{ codigo: { contains: query, mode: 'insensitive' } }, { nombre: { contains: query, mode: 'insensitive' } }, { correo: { contains: query, mode: 'insensitive' } }] } : undefined, orderBy: { codigo: 'asc' } }); }
