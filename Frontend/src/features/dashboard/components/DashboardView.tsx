...
export function DashboardView() {
  ...
  return <>
    <section className={`page-heading ${styles.heading}`}><div><h1>Panel de Control Operativo</h1><p>Semestre 2026-3 · Martes, 25 de agosto · Bloque actual 08:00–10:00</p></div><span className={styles.live}><i />Actualización en tiempo real</span></section>
