...
export function ResumenHoras({ resumen, incluirAlertas = false, detalle = false, memorandums = 0 }: { resumen:ResumenMonitor; incluirAlertas?:boolean; detalle?:boolean; memorandums?:number }) {
