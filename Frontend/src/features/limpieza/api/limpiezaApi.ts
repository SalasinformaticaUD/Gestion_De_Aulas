...
export type CleaningSuggestion = { aula: { id: string; codigo: string; ubicacion: string }; ultimaLimpieza: string | null; diasSinLimpieza: number | null; motivo: string };
export type CleaningMatrix = { desde: string; hasta: string; fechas: string[]; aulas: Array<{ id: string; codigo: string; ubicacion: string; jornadas: Array<{ fecha: string; realizada: boolean; registros: Array<{ id: string; realizadaEn: string; observacion: string | null }> }> }> };
