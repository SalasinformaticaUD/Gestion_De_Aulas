...
export type DisponibilidadApi = { aula: { id: string; codigo: string; ubicacion: string; piso: number | null; capacidad: number }; estadoCalculado: string; motivo: string; fuentes: Array<{ tipo: string; descripcion: string; estado?: string }> };
