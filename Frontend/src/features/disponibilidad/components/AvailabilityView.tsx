...
export function AvailabilityView() {
  ...
  const cargar = useCallback(async () => { try { setError(null); setResultados(await consultarDisponibilidad(fecha, horaInicio, horaFin)); } catch (cause) { setError(cause instanceof Error ? cause.message : "No fue posible consultar disponibilidad."); } }, [fecha, horaInicio, horaFin]);
  useEffect(() => {
    void cargar();
